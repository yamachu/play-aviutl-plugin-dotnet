...
";
        ...
        private static void GenerateNativeLibraryClass(SourceProductionContext context, PluginClassInfo pluginClass)
        {
            ...
            var isWithoutConfigPlugin = pluginClass.InterfaceName.Contains("WithoutConfig");
...
{{
    ...
    {{
        private static readonly {pluginClass.ClassName} plugin = new {pluginClass.ClassName}(
            ...
            &FuncReadVideo,
            &FuncReadAudio,
            {(isWithoutConfigPlugin ? "null" : "&FuncConfig")}
        );
...
";
    ...
    public class PluginClassInfo
    {
        ...
        public PluginClassInfo(string className, string namespaceName, string interfaceName, string handleTypeName)
        {
            ClassName = className ?? "";
